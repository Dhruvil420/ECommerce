...
namespace ECommerceApp.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,Quantity")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,Quantity")] CartItem cartItem)
        {
            if (id != cartItem.Id)
            {
                return NotFound();
